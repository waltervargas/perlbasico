...
teclado, se necesita una seÃ±al para la finalizaciÃ³n de la entrada, en Unix es CTRL-D.

=item 2. Escriba un programa que lea una lista de nÃºmeros separados por lineas
y por cada nÃºmero imprima el nombre correspondiente a la lista mostrada a
continuaciÃ³n. fred betty barney dino wilma pebbles bamm-bamm. Por ejemplo, 
