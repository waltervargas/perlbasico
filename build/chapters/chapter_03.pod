...
=item 1. Escriba una funciÃ³n llamada "total" que retorne el total de una lista
de nÃºmeros. (Nota: la funciÃ³n no debe realizar algÃºn tipo de I/O, esta debe
simplemente procesar sus parÃ¡metros y retornar un valor). Complete el siguiente
programa de ejemplo con la funciÃ³n "total", el resultado de la sumatoria debe
dar 25 para el primer grupo de nÃºmeros.
...
=begin programlisting
	...
	print "Ingrese algunos nÃºmeros separados por lineas: ";
	my $user_total = total(<STDIN>);
	print "El total para los nÃºmeros ingresados es: $user_total.\n";

=end programlisting

=item 2. Usando la funciÃ³n escrita en el ejercicio anterior, realice un
programa que calcule la sumatoria de todos los nÃºmeros del 1 al 1000.

=item 3. Escriba una funciÃ³n llamada &above_average que tome una lista de
nÃºmeros y retorne solo aquellos nÃºmeros que estÃ©n por encima del promedio
(Nota: escriba otra funciÃ³n que calcule el promedio de varios nÃºmeros
dividiendo el total de la sumatoria de los nÃºmeros por el numero de items). Use
su funciÃ³n para probar el siguiente programa:
...
=item 4. Escriba una funciÃ³n llamada "saludo", que de la bienvenida a una
...
Esto debe escribir lo siguiente:
	...
	Hola Fred! Eres el primero aquÃ­!
	Hola Barney! Fred tambiÃ©n esta aquÃ­!
