...
\vspace{-6pt}
\normalsize
Un f\mbox{}ilehandle abierto para escritura puede usarse con \texttt{print} o \texttt{printf}, colocandolo inmediatamente despues de la palabra reservada pero antes de la lista de argumentos:
