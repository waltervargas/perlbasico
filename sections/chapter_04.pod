...
llamada a C<open>. En general, es mejor cerrar cada filehandle pronto despues
...
aunque no estan relacionadas con los procesos de I/O nos va a permitir salir de
...
colocandolo inmediatamente despues de la palabra reservada pero antes de la
lista de argumentos: 
...
volver al valor por defecto STDOUT. De igualmanera, por defecto, la salida
...
lellendo el log para monitorear el progreso del programa, puedes hacer algo
como esto: 
