...
Las matrices o listas pueden tener cualquier número de elementos. La lista más
pequeña es aquella que no tiene elementos, mientras que la más grande puede
llenar toda la memoria disponible. Una vez más esto es parte de la filosofía de
Perl "No hay límites innecesarios".
...
Por su puesto, el subíndice puede ser cualquier expresión que devuelva un valor
...
Si se indica un elemento en el subíndice que este más allá del final del
...
permite que uses cualquier carácter de puntuación como delimitador. Algunos
...
corchetes de indices) para referirse a toda la matriz. Este símil funciona a
...
ultima linea leída de la entrada estándar. En contexto de lista, este operador
...
Cuando la entrada estándar es un archivo, esto va a leer el archivo completo
