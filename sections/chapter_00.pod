...
cubierta del legendario libro B<The Camel Book>, conocido tambien como
...
usar la función. De esta manera,  podrás encontra lineas de código en Perl como
las siguientes: 
...
En su totalidad, sin usar los atajos y los valores por defecto de Perl, este
trozo de código seria aproximadamente 10 o 12 veces mas largo, entonces tomaria
mas tiempo para escribirlo y leerlo. Va a ser mas duro de mantener y depurar
cuando tenga mas variables. 


=head1 ¿ Como se hizo Perl tan popular ?    
...
Creció en portabilidad. Lo que antes era un lenguaje poco disponible en solo un
par de sistema tipo Unix,  ahora tiene miles de páginas de documentación en
linea gratis, docenas de libros, y miles de listas de correo en cientos de
...
=head1 ¿ Que esta pasando con Perl ahora ?    

Z<¿ Que esta pasando con Perl ahora ?> 
...
L<http://search.cpan.org> o L<http://kobesearch.cpan.org> para navegar o buscar
...
dos años sin actualizares es definitivamente una antiguedad. 

=head1 ¿ Como hacer un programa en Perl ?    

Z<¿ Como hacer un programa en Perl ?> 
...
en su editor de textos preferido,  yo personalmente prefiero B<VIM>. (Usted no
...
algún lenguaje de programación que tenga raices Unix, va a comenzar con 
B<Hola, Mundo>,  por ejempo en Perl seria así: 
